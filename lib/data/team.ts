...
export const teamGroups: { group: string; members: TeamMember[] }[] = [
  {
    ...
    members: [
      ...
      { name: "Lexi Little", title: "Director of People & Operations", image: "/images/team/lexi-little.png" },
      { name: "Luke Spence", title: "Director of Technical Programming", image: "/images/team/luke-spence.png" },
    ],
  },
  {
    group: "Programming",
