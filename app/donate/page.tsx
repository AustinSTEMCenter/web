  ...
  return (
    <>
      <PageIntro
        ...
        title={
          <>
            Austin STEM Center exists because every person deserves the opportunity to{" "}
            <span className="hl-green">discover what they&rsquo;re capable of.</span>
          </>
        }
      ...
      >
        <div className="prose-note mt-6">
          ...
          <p>
            Your gift funds impact you can see and experiences you can feel. From scholarship
            opportunities and fully funded field trips to the tools, materials, and equipment that
            bring hands-on STEM learning to life every day.
          </p>
        </div>
      </PageIntro>
      ...
      <div className="mt-12 flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-12">
          ...
          <div className="tape relative border border-ink/18 bg-card px-3 pt-8 pb-6 shadow-[3px_4px_0_rgba(56,52,42,0.12)] sm:px-7">
            <div className="flex flex-wrap items-baseline justify-between gap-x-4 px-2 sm:px-0">
              <h2 className="text-[17px] font-bold">
                Donate to ATX Robotics d/b/a Austin STEM Center
              </h2>
              <span className="-rotate-1 font-hand text-[20px] text-rust">$10 minimum</span>
            </div>
        ...
        <aside className="tape relative max-w-[520px] rotate-[0.8deg] border border-ink/18 bg-card px-7 pt-7 pb-6 shadow-[3px_4px_0_rgba(56,52,42,0.12)] lg:mt-14 lg:max-w-[340px]">
          ...
          <p className="mt-2 text-[15px] leading-relaxed text-ink-soft">
            Prefer to give another way? The fastest way to support ASC is to{" "}
            <Link
              href="/contact"
